...
class GameServer_fix(url:String="jdbc:mysql://localhost:3306/lccgame",user:String="host",password:String="host") extends InstitutionRESTServer(new ResourceProtocolStore("/phpgameprotocols")) with Asking {
