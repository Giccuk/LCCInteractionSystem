    ...
    if (isset($_POST["investoroffer"])&&!empty($_POST["investoroffer"])){
        ...
        if ($interactionid_investorside!=""){
          ...
          if (count($allagentsstates["agents"])==2){
            ...
            msgstorecsv("{$gameprotocol_id}","{$firstagent_id}","{$firstagent_role}","{$secondagent_id}","{$secondagent_role}","e(invest({$_POST["investoroffer"]}#{$secondagent_id}))");
            ...
            msgstorecsv("{$gameprotocol_id}","{$secondagent_id}","{$secondagent_role}","{$firstagent_id}","{$firstagent_role}","e(repay({$trusteerepay}#{$firstagent_id}))");
